...
function ContactDetailPage() {
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/contacts')} className="text-blue-500 hover:text-blue-400 mt-4 cursor-pointer">
            ← Back to Contacts
          </button>
        </div>
      </div>
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <button onClick={() => navigate('/contacts')} className="text-gray-400 hover:text-white transition-colors cursor-pointer flex items-center gap-2">
        ← Back to Contacts
      </button>
      ...
      <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleDelete} className="bg-red-900/50 hover:bg-red-800/50 text-red-400 px-4 py-2 rounded-lg text-sm font-medium transition-colors cursor-pointer">
              🗑️ Delete
            </button>
          </div>
        </div>
